...
export default function StoreDetails() {
    ...
    }, [params.id]) //recomendável utilizar a variável utilizada como dependência para caso de mudanças
  ...
  <Text style={styles.description}>{store.about}</Text>
        ...
        <Text style={styles.title}>Instruções para visita</Text>
            <Text style={styles.description}>{store.instructions}</Text>

        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            <Feather name="clock" size={40} color="#2AB5D1" />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {store.opening_hours}</Text>
          </View>
